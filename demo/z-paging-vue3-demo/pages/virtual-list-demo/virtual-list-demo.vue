<!-- 虚拟列表演示(一般写法)(vue) -->
<!-- 请注意1：use-inner-list在微信小程序中部分较高版本调试库会报More than one slot named "cell" are found...的警告并导致开发者工具卡顿，将基础库版本调到2.18.0以下即可。因线上没有控制台打印，因此不会影响线上版本。 -->
<!-- 在微信小程序中如果是vue2推荐使用虚拟列表兼容写法(virtual-list-compatibility-demo)，如果是vue3推荐使用虚拟列表非内置列表写法(virtual-list-no-inner-demo.vue) -->
<!-- 在vue3+微信小程序中会出现滚动列表莫名触发底部加载更多和More than one slot named "cell" are found...等问题，在vue2+微信小程序中会出现和More than one slot named "cell" are found...的问题，在非微信小程序平台兼容性良好 -->
<template>
	<view class="content">
